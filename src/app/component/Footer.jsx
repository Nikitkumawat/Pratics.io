        ...
        <div className="NewFooter_top__zG1Js">
          <div className="NewFooter_topBox__qITBs">
            <div className="NewFooter_one__FZicU">
              <a href="#">
                <img
                  ...
                  width="80"
                  height="70"
                  className="NewFooter_img__N_Vqq"
                  style={{ color: "transparent", marginTop: "5px" }}
                  src="images/nav_logo.e5fb945a.png"
                />
              </a>
              <span className="NewFooter_today__0jVMb">
            ...
            <div className="NewFooter_two__w3Wjr">
              ...
              <a
                target="blank"
                className="NewFooter_two_tab__s_86D"
              ...
              <a href="about.html" className="NewFooter_two_tab__s_86D">
                Life at LENS
              </a>
            </div>
        ...
        <div className="NewFooter_bot__Cr8m6">
          <div className="NewFooter_bot_box__GS61E">
            <span style={{ color: "#999999" }}>
              2023
              <span style={{ color: "white" }}>LENS, Inc. </span>All rights
              reserved.
            </span>
            <div className="NewFooter_bot_smolBox__vVWBa">
              <a href="Files/LENS_Code_of_Conduct.pdf" target="_blank"></a>
