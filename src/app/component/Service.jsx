...
function Service() {
  return (
    <div className="NewServices_Container__MqkmW" id="services">
      ...
      <p className="NewServices_subHead__NjkSp">
        We provide Artificial Intelligence Services
      </p>
      <div className="NewServices_cardCont__m0LU2">
        <div
          style={{ position: "relative" }}
          className="NewServices_cardBox__c99Fz"
        >
          ...
          <div className="NewServiceCard_headerCard__438DV">
            <div>
              <div className="NewServiceCard_headingCont__QkfmB">
                <div>
                  <span className="NewServiceCard_number__FPZAO">01</span>
                </div>
                <div
                  style={{ border: "none", color: "#01c99b" }}
                  className="NewServiceCard_cardHead__JPzMC"
                >
                  Biometrics
                </div>
              </div>
              <h5
                style={{ border: "none" }}
                className="NewServiceCard_cardBody__d0fwE"
              >
        ...
        >
          ...
          <div className="NewServiceCard_headerCard__438DV">
            <div>
              <div className="NewServiceCard_headingCont__QkfmB">
                <div>
                  <span className="NewServiceCard_number__FPZAO">02</span>
                </div>
                <div
                  style={{ border: "none", color: "#3fbdf1" }}
                  className="NewServiceCard_cardHead__JPzMC"
                >
                  Image Analysis
                </div>
        ...
        >
          ...
          <div className="NewServiceCard_headerCard__438DV">
            <div>
              <div className="NewServiceCard_headingCont__QkfmB">
                <div>
                  <span className="NewServiceCard_number__FPZAO">03</span>
                </div>
                <div
                  style={{ border: "none", color: "#ff605f" }}
                  className="NewServiceCard_cardHead__JPzMC"
                >
        ...
        >
          ...
          <div className="NewServiceCard_headerCard__438DV">
            <div>
              <div className="NewServiceCard_headingCont__QkfmB">
                <div>
                  <span className="NewServiceCard_number__FPZAO">04</span>
                </div>
                <div
                  style={{ border: "none", color: "#ff9f31" }}
                  className="NewServiceCard_cardHead__JPzMC"
                >
